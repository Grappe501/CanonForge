...
> **Master registry** · every BUILD document · version · status · traceability
> CF-CON-156 · CF-ENTRY-036
...
BUILD-040                             → Phase III **v1.0** · **Story Genome complete**
BUILD-053+                            → Phase IV+ · queued
architecture/                         → expanded specs (derived · cross-ref)
knowledge/entries/                    → verbatim source uploads
```

**Conflict rule:** Constitution (000) wins over all BUILD docs. BUILD docs win over architecture specs.

---

## Registry

| BUILD | Title | Version | Status | Entry | Concepts | Document |
|---|---|---|---|---|---|---|
| **000.000** | The Constitution | ratified | **Law** | 033 | CF-CON-136 | [CONSTITUTION.md](../CONSTITUTION.md) |
...
| **040** | The Convergence Engine | **1.0** | **Frozen** | 080 | CF-CON-837–856 | [BUILD-040](BUILD-040-convergence-engine.md) |
| **053–072** | Roadmap v2 phases | — | **Queued** | — | — | [CHRONOFORGE_ROADMAP](../architecture/CHRONOFORGE_ROADMAP.md) |
...
5. BUILD-004 Seven Immutable Laws — **physics of the universe**
...
*BUILD Index v1.0.0 · CF-ENTRY-036 · CHRONOFORGE Project v0.0.1*
